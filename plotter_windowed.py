...
class PlotterWindowed:
    ...
    def __init__(self, datasets, z_samples_size, **kwargs):
        ...
        self.plotter = ProcessPlotter(datasets.x_dimensions, labels, **kwargs)
    ...
    def plot_datasets(self, y_pred_d, y_predict_mat, orderings):
        ...
        if len(self.x_dimensions) == 1:
            self._plot_datasets_zlines(y_predict_mat, orderings)
        self._plot_datasets_preds(y_pred_d)

    def _plot_datasets_zlines(self, y_predict_mat, orderings):
    ...
    def _plot_datasets_preds(self, y_pred_d):
